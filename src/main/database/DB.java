...
public class DB {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            String urlString = "http://jira.genband.com/rest/auth/1/session";
            String postJsonData = "{\"username\":\"ferhaty\",\"password\":\"YLCNFRHT.34\"}";
            String response = HttpRequest.postRequest(urlString,postJsonData);
            String sessionID = SessionParser.getSessionID(response);
            Session.setSessionID(sessionID);
            ArrayList<String> statusList = StatusParser.parse(HttpRequest.getRequest("http://jira.genband.com/rest/api/2/issuetype"));
